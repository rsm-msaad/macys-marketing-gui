...
# Heavy imports (faiss, sentence_transformers) deferred to _ensure_loaded()
# to avoid pulling ~400 MB of torch into memory at module import time.
# The SentenceTransformer model is shared with the naive Retriever via
