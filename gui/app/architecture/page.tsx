...
const LAYERS: Layer[] = [
  ...
  },
  {
    ...
    components: [
      ...
      { name: "Product Catalog (61 SKUs)", description: "Realistic Macy's beauty products across 27 brands. Includes MAP protection, vendor commitments, seasonal tags.", path: "ai_engine/automations/sku-recommender/product_catalog.json" },
