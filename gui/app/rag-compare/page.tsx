...
const EXAMPLE_QUERIES = [
  ...
  "Can I include MAC products in a discount campaign?",
  "What is the standard tagline for spring beauty campaigns?",
  "How long should a tagline be?",
  "Why did the Q4 2025 holiday campaign underperform?",
];
...
function ResultCard({
  ...
  return (
    <div className="rounded-lg border border-charcoal/10 bg-white p-4">
      ...
      {matchedVia === "chunk" && (
        <div className="mt-2 text-[10px] text-charcoal/40">Matched via raw chunk text</div>
      )}
    </div>
  );
}
