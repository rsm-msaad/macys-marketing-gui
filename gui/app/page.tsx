      ...
      <div className="relative z-10 flex h-full flex-col px-4 sm:px-8">
        ...
        <div className="flex flex-col items-center pt-[2.5vh] sm:pt-[3vh]">
          ...
          <motion.p
            ...
            className="mt-1.5 sm:mt-2 text-xs sm:text-xs tracking-[0.35em] uppercase text-charcoal/70 font-semibold"
          >
              ...
              >
                {ceos.map((c) => (
                  <Link key={c.id} href={`/${c.id}`} className="group flex flex-col items-center">
                    ...
                    <span className="mt-1.5 text-xs sm:text-xs font-semibold text-charcoal/90">{c.name}</span>
                ...
                <div className="relative flex items-center justify-center" style={{ height: "clamp(260px, 44vh, 420px)" }}>
                  ...
                  <AnimatePresence mode="popLayout">
                    ...
                    >
                      ...
                      <span className="mt-1.5 text-xs sm:text-xs text-charcoal/65 font-semibold">{prev?.name}</span>
                    </motion.button>
                  </AnimatePresence>
                    ...
                    {cur && (
                      ...
                      >
                        <Link href={`/${cur.id}`} className="flex flex-col items-center group">
                          ...
                          <p className="mt-0.5 text-xs sm:text-xs uppercase tracking-[0.2em] text-charcoal/80 font-semibold">
                            {cur.title}
                          </p>
                  ...
                  <AnimatePresence mode="popLayout">
                    ...
                    >
                      ...
                      <span className="mt-1.5 text-xs sm:text-xs text-charcoal/65 font-semibold">{next?.name}</span>
                    </motion.button>
                  </AnimatePresence>
