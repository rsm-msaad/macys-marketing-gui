...
- **Hourly labor cost:** $75/hour fully loaded (salary + benefits + overhead) for a mid-to-senior marketing operations role. This is a reasoned assumption, not a claimed Macy's figure. Public job postings for campaign managers, marketing operations leads, and senior production designers in major metro markets such as New York show base salaries roughly in the $95K-$120K range. A standard 1.3x-1.4x multiplier for benefits, payroll taxes, and overhead (office space, tools, HR) gives a fully loaded cost of roughly $124K-$168K per year, or approximately $59-$81/hour at 2,080 working hours per year. We use $75 as a round midpoint within that range. Actual costs vary by role, geography, and seniority; this estimate is appropriate for a class-context projection and would need to be validated with internal HR data for a production deployment.
